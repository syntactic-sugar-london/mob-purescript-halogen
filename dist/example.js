...
(function(exports) {
  ...
  var myButton = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Button line 45, column 10 - line 54, column 24: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var main = (function () {
      var handle = function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Button was toggled to: " + Data_Show.show(Data_Show.showBoolean)(v.value0)))(function () {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(new Data_Maybe.Just(Data_Unit.unit));
          });
      };
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Button.myButton)(Data_Unit.unit)(v))(function (v1) {
              return v1.subscribe(Control_Coroutine.consumer(Effect_Aff.monadAff)(handle));
          });
      }));
  })();
  exports["main"] = main;
